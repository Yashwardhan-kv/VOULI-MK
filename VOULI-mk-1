...
class Widget:
    def __init__(self):
       root = Tk()
       root.title('VOULI(MK-1)')
       root.config(background='Red')
       root.geometry('350x600')
       root.resizable(0, 0)
       root.iconbitmap(r'C:\Users\skt\Documents\Vouli Mark I\Untitled-1.ico')
       img = ImageTk.PhotoImage(Image.open(r"C:\Users\skt\Documents\Vouli Mark I\vouli image 2.png"))
       ...
       compFrame = LabelFrame(root, text="VOULI", font=('Black ops one', 10, 'bold'))
       ...
       speak('Hello, I am vouli! What should I do for You?')
       self.compText.set('Hello, I am vouli! What should I do for You?')
        ...
        if 'open ccleaner' in query:
            ...
            if 'me' in recipient:
                try:
                    ...
                    self.compText.set('Email sent!')
                    speak('Sorry ' + 'Shiv' + '!, I am unable to send your message at this moment!')
            ...
            self.compText.set('Okay')
            speak('okay')
            self.compText.set('Bye Shiv, have a good day.')
            speak('Bye Shiv, have a good day.')
           
        elif 'hello' in query:
            self.compText.set('Hello Shiv')
            speak('Hello Shiv')
            ...
            try:
                ...
                speak('I don\'t know Shiv! Google is smarter than me!')
                self.compText.set('I don\'t know Shiv! Google is smarter than me!')
